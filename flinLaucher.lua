...
function main()
    ...
    msg('Ëàóí÷åð óñïåøíî çàïóùåí. Àêòèâàöèÿ: /launcher')
    ...
    if mainMenu.v then
        ...
        imgui.Begin('Flin Launcher', nil, imgui.WindowFlags.NoResize + imgui.WindowFlags.NoCollapse + imgui.WindowFlags.NoScrollbar)
            ...
            imgui.BeginChild('##1server', imgui.ImVec2(220, 70), false)
                ...
                imgui.CenterText(u8'Ñåðâåð 01 v2')
                imgui.SetCursorPos(imgui.ImVec2(5, 30))
                if imgui.Button(u8'Ïðèñîåäèíèòüñÿ', imgui.ImVec2(210, 30)) then sampConnectToServer("193.84.90.17", 7771) end
                imgui.PopFont()
            ...
            imgui.BeginChild('##2server', imgui.ImVec2(220, 70), false)
                ...
                imgui.PushFont(fontServera)
                imgui.CenterText(u8'Ñåðâåð 02')
                imgui.SetCursorPos(imgui.ImVec2(5, 30))
                if imgui.Button(u8'Ïðèñîåäèíèòüñÿ', imgui.ImVec2(210, 30)) then sampConnectToServer("193.84.90.17", 7772) end
                imgui.PopFont()
            ...
            imgui.BeginChild('##update', imgui.ImVec2(470, 140), false)
                ...
                if imgui.Button(u8'Ïðîâåðèòü îáíîâëåíèå', imgui.ImVec2(190, 25)) then
